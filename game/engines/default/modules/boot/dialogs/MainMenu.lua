...
--	l[#l+1] = {name="Online Profile", fct=function() game:registerDialog(require("mod.dialogs.Profile").new()) end}
	l[#l+1] = {name="View High Scores dazdad azd azd azd azd azd azd azd azdazdzerfgzerg", fct=function() game:registerDialog(require("mod.dialogs.ViewHighScores").new()) end}
