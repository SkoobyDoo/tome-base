...
newTalent{
	...
	info = function(self, t)
		...
		return ([[Fire an arrow for %d%% weapon damage.  When the arrow reaches its destination or hits a target it will draw in enemies in a radius of %d and inflict %0.2f physical damage.
