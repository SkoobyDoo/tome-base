...
newTalent{
	...
	info = function(self, t)
		...
		When using a two handed weapon this way you suffer a 20%% hit chance penalty (unaffected by accuracy), decreasing by 5%% per size category above #{italic}#big#{normal}#.]]):
