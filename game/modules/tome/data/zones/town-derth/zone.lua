...
return {
	...
	min_material_level = function() if game.state.stores_restock >= 3 then return 2 elseif game.state.stores_restock >= 2 then return 1 else return 1 end end,
	max_material_level = function() if game.state.stores_restock >= 3 then return 3 elseif game.state.stores_restock >= 2 then return 2 else return 1 end end,
