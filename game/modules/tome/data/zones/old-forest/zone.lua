...
--			rooms = {"forest_clearing", {"lesser_vault",8}},
			rooms = {"forest_clearing", "small_x", "cross", {"lesser_vault",50}, {"greater_vault",15}},
--			required_rooms = {"TMXtest"},
			required_rooms = {"greater_vault", "lesser_vault"},
--			rooms = {"forest_clearing", "small_x", "TMXtest", {"lesser_vault",50}, {"greater_vault",35}},
...
--			lesser_vaults_list = {"mage-hideout", "snow-giant-camp", "honey_glade"},
--			lesser_vaults_list = {"bandit-fortress"},
			lesser_vaults_list = {"loot-vault", "rat-nest"},
--			lesser_vaults_list_add = {"circle"},
--			greater_vaults_list = {"test2"},
--			greater_vaults_list = {"greater-checkerboard", "diggers"},
--			greater_vaults_list_add = {"greater-checkerboard"},
