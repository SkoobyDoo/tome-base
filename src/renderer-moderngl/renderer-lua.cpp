...
template<class T=DisplayObject>
T* userdata_to_DO(lua_State *L, int index, const char *auxclass = nullptr) {
	DisplayObject **ptr;
	if (auxclass) {
...
{
	DisplayObject **r = (RendererGL**)lua_newuserdata(L, sizeof(DisplayObject*));
