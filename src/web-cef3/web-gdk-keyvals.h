...
int get_gdk_keyval_from_sdl_scancode(int scancode) {
	switch (scancode) {
		...
		case SDLK_SPACE: return GDK_KEY_space;
		case SDLK_PLUS: return GDK_KEY_plus;
		case SDLK_MINUS: return GDK_KEY_minus;
		case SDLK_EQUALS: return GDK_KEY_equal;
		case SDLK_LEFTBRACKET: return GDK_KEY_bracketleft;
		case SDLK_RIGHTBRACKET: return GDK_KEY_bracketright;
		case SDLK_BACKSLASH: return GDK_KEY_backslash;
		case SDLK_COLON: return GDK_KEY_colon;
		case SDLK_SEMICOLON: return GDK_KEY_semicolon;
		case SDLK_QUOTE: return GDK_KEY_apostrophe;
		case SDLK_BACKQUOTE: return GDK_KEY_grave;
		case SDLK_COMMA: return GDK_KEY_comma;
		case SDLK_PERIOD: return GDK_KEY_period;
		case SDLK_SLASH: return GDK_KEY_slash;
		case SDLK_CAPSLOCK: return GDK_KEY_Caps_Lock;
		case SDLK_F1: return GDK_KEY_F1;
		case SDLK_F2: return GDK_KEY_F2;
		case SDLK_F3: return GDK_KEY_F3;
		case SDLK_F4: return GDK_KEY_F4;
		case SDLK_F5: return GDK_KEY_F5;
		case SDLK_F6: return GDK_KEY_F6;
		case SDLK_F7: return GDK_KEY_F7;
		case SDLK_F8: return GDK_KEY_F8;
		case SDLK_F9: return GDK_KEY_F9;
		case SDLK_F10: return GDK_KEY_F10;
		case SDLK_F11: return GDK_KEY_F11;
		case SDLK_F12: return GDK_KEY_F12;
		case SDLK_PRINTSCREEN: return GDK_KEY_Print;
		case SDLK_SCROLLLOCK: return GDK_KEY_Scroll_Lock;
		case SDLK_PAUSE: return GDK_KEY_Pause;
		case SDLK_INSERT: return GDK_KEY_Insert;
		case SDLK_HOME: return GDK_KEY_Home;
		case SDLK_PAGEUP: return GDK_KEY_Page_Up;
		case SDLK_DELETE: return GDK_KEY_Delete;
		case SDLK_END: return GDK_KEY_End;
		case SDLK_PAGEDOWN: return GDK_KEY_Page_Down;
		...
		case SDLK_NUMLOCKCLEAR: return GDK_KEY_Clear;
		case SDLK_KP_DIVIDE: return GDK_KEY_KP_Divide;
		case SDLK_KP_MULTIPLY: return GDK_KEY_KP_Multiply;
		case SDLK_KP_MINUS: return GDK_KEY_KP_Subtract;
		case SDLK_KP_PLUS: return GDK_KEY_KP_Add;
		case SDLK_KP_ENTER: return GDK_KEY_KP_Enter;
		case SDLK_KP_PERIOD: return GDK_KEY_KP_Decimal;
		case SDLK_KP_1: return GDK_KEY_KP_1;
		case SDLK_KP_2: return GDK_KEY_KP_2;
		case SDLK_KP_3: return GDK_KEY_KP_3;
		case SDLK_KP_4: return GDK_KEY_KP_4;
		case SDLK_KP_5: return GDK_KEY_KP_5;
		case SDLK_KP_6: return GDK_KEY_KP_6;
		case SDLK_KP_7: return GDK_KEY_KP_7;
		case SDLK_KP_8: return GDK_KEY_KP_8;
		case SDLK_KP_9: return GDK_KEY_KP_9;
		case SDLK_KP_0: return GDK_KEY_KP_0;
		case SDLK_LCTRL: return GDK_KEY_Control_L;
		case SDLK_LSHIFT: return GDK_KEY_Shift_L;
		case SDLK_LALT: return GDK_KEY_Alt_L;
		case SDLK_RCTRL: return GDK_KEY_Control_R;
		case SDLK_RSHIFT: return GDK_KEY_Shift_R;
		case SDLK_RALT: return GDK_KEY_Alt_R;
		case SDLK_LGUI: return GDK_KEY_Meta_L;
		case SDLK_RGUI: return GDK_KEY_Meta_R;
		case SDLK_MENU: return GDK_KEY_Menu;
		case SDLK_LEFTPAREN: return GDK_KEY_parenleft;
		case SDLK_RIGHTPAREN: return GDK_KEY_parenright;
		case SDLK_KP_LEFTBRACE: return GDK_KEY_braceleft;
		case SDLK_KP_RIGHTBRACE: return GDK_KEY_braceright;
		case SDLK_LESS: return GDK_KEY_less;
		case SDLK_GREATER: return GDK_KEY_greater;
		case SDLK_KP_VERTICALBAR: return GDK_KEY_bar;
		case SDLK_EXCLAIM: return GDK_KEY_exclam;
		case SDLK_QUOTEDBL: return GDK_KEY_quotedbl;
		case SDLK_HASH: return GDK_KEY_numbersign;
		case SDLK_PERCENT: return GDK_KEY_percent;
		case SDLK_DOLLAR: return GDK_KEY_dollar;
		case SDLK_AMPERSAND: return GDK_KEY_ampersand;
		case SDLK_ASTERISK: return GDK_KEY_asterisk;
		case SDLK_QUESTION: return GDK_KEY_question;
		case SDLK_AT: return GDK_KEY_at;
		case SDLK_UNKNOWN: return GDK_KEY_periodcentered;
		case SDLK_CARET: return GDK_KEY_caret;
		case SDLK_UNDERSCORE: return GDK_KEY_underscore;
		default: return scancode;
	}
}

int get_gdk_keyval_from_uni(int uni) {
	switch (uni) {
		default: return uni;
	}
}
